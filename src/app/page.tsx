    ...
    <div>
      <div className="w-[95%] flex flex-row-reverse mb-2">
       ...
       me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
        ...
        />
        <EditItemModal
          id={opened.editModal as number}
          onClose={() => setOpened({ ...opened, editModal: null })}
          isOpen={opened.editModal !== null}
          updateData={updateData}
        />
      </div>
              ...
              {data.map((e, i) => {
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">{e.owner}</td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex gap-2">
                        <button
                          onClick={() =>
                            setOpened({ ...opened, editModal: e.id })
                          }
